...
<script>
    ...
    <%--alert("host=" + location.host + ",ctx=" + "${ctx}");--%>
    var ws = null;
    var wsServer = "ws://" + location.host + "${ctx}" + "/chatServer/${userid}";
    <%--var wsServer = "ws://192.168.51.75:8080"+"${ctx}"+"/chatServer/${userid}";--%>
    ...
    function showChat(message) {
        ...
        $.getJSON(url, function (data) {
            pic = "${ctx}/icons/" + data.profilehead;
